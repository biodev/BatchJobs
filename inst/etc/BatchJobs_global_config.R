...
mail.error = "none"
db.driver = "SQLite"
default.resources <- list(universe='vanilla', R.bin.path=ifelse(as.character(Sys.info()["nodename"]) == "morgan2.ohsu.edu", file.path(dirname(dirname(find.package("BatchJobs"))), "bin", "R"), "/usr/bin/R"), memory='5 GB', cpus='1', walltime=10*60)
